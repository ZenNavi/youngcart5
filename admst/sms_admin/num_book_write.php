...
<div class="tbl_frm01 tbl_wrap">
        ...
        <td>
            ...
            <div id="hp_check_el">
                ...
                foreach( $exist_hplist as $v ) {
                    ...
                    if( empty($v) ) continue;
                    $href = G5_ST_ADMIN_URL."/member_form.php?w=u&amp;mb_id={$v['mb_id']}";
                ?>
    ...
    <tr>
        ...
        <td> <?php echo $write['mb_id'] ? '<a href="'.G5_ST_ADMIN_URL.'/member_form.php?w=u&amp;mb_id='.$write['mb_id'].'">'.$write['mb_id'].'</a>' : '비회원'?> </td>
    </tr>
    <tr>
        ...
        success: function(data) {
            if(data.error) {
                ...
                $.each( data.exist , function(num) {
                    ...
                    if(list_data) {
                        var href = "<?php echo G5_ST_ADMIN_URL ?>/member_form.php?w=u&mb_id="+list_data;
