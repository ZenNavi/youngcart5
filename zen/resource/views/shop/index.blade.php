...
<div class="sidx">
    <section id="anc_sidx_ord">
        ...
        for($i=6; $i>=0; $i--) {
            ...
            $x_val[] = $date;
            $arr_order[] = \App\Service\ShopService::get_order_date_sum($date);
        }

        $max_y = \App\Service\ShopService::get_max_value($arr_order);
    ...
    <div id="sidx_stat">
        <section id="anc_sidx_act">
            ...
            <div id="sidx_take_act" class="tbl_head01 tbl_wrap">
                <table>
                    ...
                    <tr>
                        <?php
                        $info = \App\Service\ShopService::get_order_status_sum('주문');
                        ?>
                    ...
                    <tr>
                        <?php
                        $info = \App\Service\ShopService::get_order_status_sum('입금');
                        ?>
                    ...
                    <tr>
                        <?php
                        $info = \App\Service\ShopService::get_order_status_sum('준비');
                        ?>
                    ...
                    <tr>
                        <?php
                        $info = \App\Service\ShopService::get_order_status_sum('배송');
                        ?>
        ...
        <section id="anc_sidx_stock">
            ...
            if ($config['cf_sms_use'] && $config['cf_icode_id'] && $config['cf_icode_pw']) {
                $userinfo = \App\Service\ShopService::get_icode_userinfo($config['cf_icode_id'], $config['cf_icode_pw']);
            }
            ?>
    ...
    <div id="sidx_settle" class="tbl_head01 tbl_wrap">
        <table>
            ...
            <tr>
                ...
                for($i=($term - 1); $i>=0; $i--) {
                $date = date("Y-m-d", strtotime('-'.$i.' days', G5_SERVER_TIME));
                $info[$date] = \App\Service\ShopService::get_order_settle_sum($date);
