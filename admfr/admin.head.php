...
$files = glob(G5_FR_ADMIN_PATH.'/css/admin_extend_*');
if (is_array($files)) {
    foreach ((array) $files as $k=>$css_file) {
        ...
        $css_file = str_replace(G5_FR_ADMIN_PATH, G5_FR_ADMIN_URL, $css_file);
...
<header id="hd">
    ...
    <div id="hd_top">
       ...
       <div id="logo"><a href="<?php echo G5_FR_ADMIN_URL ?>"><img src="<?php echo G5_FR_ADMIN_URL ?>/img/logo.png" alt="<?php echo $config['cf_title'] ?> 관리자"></a></div>
        ...
        <div id="tnb">
            <ul>
                ...
                <li class="tnb_li"><a href="<?php echo G5_FR_ADMIN_URL ?>/service.php" class="tnb_service">부가서비스</a></li>
                <li class="tnb_li"><button type="button" class="tnb_mb_btn">관리자<span class="./img/btn_gnb.png">메뉴열기</span></button>
                    <ul class="tnb_mb_area">
                        <li><a href="<?php echo G5_FR_ADMIN_URL ?>/member_form.php?w=u&amp;mb_id=<?php echo $member['mb_id'] ?>">관리자정보</a></li>
