...
$g5['title'] = $html_title;
include_once (G5_FR_ADMIN_PATH.'/admin.head.php');
        ...
        <tr>
            ...
            <td colspan="2">
                ...
                <?php } else { ?>
                    ...
                    <a href="<?php echo G5_FR_ADMIN_URL; ?>/shop_admin/itemuselist.php?sfl=a.it_id&amp;stx=<?php echo $it_id; ?>" class="btn_frmline">사용후기</a>
                    <a href="<?php echo G5_FR_ADMIN_URL; ?>/shop_admin/itemqalist.php?sfl=a.it_id&amp;stx=<?php echo $it_id; ?>" class="btn_frmline">상품문의</a>
                <?php } ?>
            </td>
        </tr>
        <tr>
...
<section id="anc_sitfrm_compact">
    ...
    <div id="sit_compact_fields"><?php include_once(G5_FR_ADMIN_PATH.'/shop_admin/iteminfo.php'); ?></div>
</section>
...
$(function(){
    $(document).on("change", "#it_info_gubun", function() {
        var gubun = $(this).val();
        $.post(
            "<?php echo G5_FR_ADMIN_URL; ?>/shop_admin/iteminfo.php",
    ...
    <div class="tbl_frm01 tbl_wrap">
        ...
        <tr>
            ...
            <td colspan="2">
                ...
                <div id="sit_option_frm"><?php include_once(G5_FR_ADMIN_PATH.'/shop_admin/itemoption.php'); ?></div>
                ...
                $(function() {
                    ...
                    $("#option_table_create").click(function() {
                        ...
                        $.post(
                            "<?php echo G5_FR_ADMIN_URL; ?>/shop_admin/itemoption.php",
        ...
        <tr>
            ...
            <td colspan="2">
                ...
                <div id="sit_option_addfrm"><?php include_once(G5_FR_ADMIN_PATH.'/shop_admin/itemsupply.php'); ?></div>
                ...
                $(function() {
                    ...
                    $("#supply_table_create").click(function() {
                        ...
                        $.post(
                            "<?php echo G5_FR_ADMIN_URL; ?>/shop_admin/itemsupply.php",
...
<?php
include_once (G5_FR_ADMIN_PATH.'/admin.tail.php');
?>
