...
<div class="sit_option_frm_wrapper">
    ...
    if($it['it_id']) {
        for($i=0; $row=sql_fetch_array($result); $i++) {
            ...
            $spl = $spl_val[1];
            $spl_supp_price = $row['io_supp_price'];
    ...
    <tr>
        ...
        <td class="td_numsmall">
            <label for="spl_supp_price_<?php echo $i; ?>" class="sound_only">상품금액</label>
            <input type="text" name="spl_supp_price[]" value="<?php echo $spl_supp_price; ?>" id="spl_supp_price_<?php echo $i; ?>" class="frm_input" size="5">
        </td>
        <td class="td_numsmall">
